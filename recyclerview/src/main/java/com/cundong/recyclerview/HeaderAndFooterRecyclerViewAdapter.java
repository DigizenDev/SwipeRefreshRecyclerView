...
public class HeaderAndFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public View getFooterView(int position) {
        return  getFooterViewsCount()>0 ? mFooterViews.get(position) : null;
    }
    ...
    public View getHeaderView(int position) {
        return  getHeaderViewsCount()>0 ? mHeaderViews.get(position) : null;
    }
    ...
    public void removeHeaderView(int headerPosition) {
        mHeaderViews.remove(headerPosition);
        this.notifyDataSetChanged();
    }
    ...
    public void removeFooterView(int footerPosition) {
        mFooterViews.remove(footerPosition);
        this.notifyDataSetChanged();
    }
